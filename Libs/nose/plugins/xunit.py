...
from Libs.nose.plugins.base import Plugin
from Libs.nose.exc import SkipTest
from Libs.nose.pyversion import force_unicode, format_exception
...
class Xunit(Plugin):
    ...
    def options(self, parser, env):
        ...
        parser.add_option(
            ...
            default=env.get('NOSE_XUNIT_FILE', 'wy_auto_nosetests.xml'),
    ...
    def report(self, stream):
        ...
        self.error_report_file.write(
            ...
            u'<testsuite name="wy_auto_test" tests="%(total)d" '
    ...
    def _getCapturedStdout(self):
        if self._currentStdout:
            ...
            if value:
                ...
                return '<system-out>%s</system-out>' % escape_cdata(value)
        return ''
    ...
    def addSuccess(self, test, capt=None):
        ...
        self.errorlist.append(
            '<testcase test_method=%(cls)s name=%(name)s '
